...
**Generating a banner — MANDATORY: use the `make_banner` MCP tool**

> **CRITICAL**: You MUST call the `make_banner` MCP tool to generate banners.
> **NEVER** attempt to build banners manually, letter-by-letter, or from any JSON data.
> The MCP tool is the ONLY supported method. Manual assembly ALWAYS produces broken output.
